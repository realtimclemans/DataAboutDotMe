...
Identity verification, secure data,public profiles
...
If you're applying to Early Decision, do you have any other commitments between June through August 2021 inclusive?
...
https://www.youtube.com/watch?v=NNWOr0vs7iI
...
I have a pretty good idea how to implement this now after a lot of thinking. So far I have email verification with Recaptcha V2 forced image matching setup. Next step is creating password creation and identity verification with government ID and webcam video.

How long have each of you been working on this? How much of that has been full-time? Please explain.
A few days. About 20 hours.
...
Spider Oak, LifeLock, LastPass, Clearview AI, Lexis Nexis, Google, Wikipedia, Whatsup, Instagram, Facebook, TikTok, Linkedin, Twitter, ProtorU, Spokeo, Zillow, Ring, Wyze

What do you understand about your business that other companies in it just don't get?
Facebook and other companies with APIs just don't get that providing personal data to untrusted third parties is ripe for disaster.

How do or will you make money? How much could you make?
(We realize you can't know precisely, but give your best estimate.)

My goal is that we will reach one billion paying customers in seven years, one year less than Facebook. We charge a starting price of $9.99/month so that will be $119,880,000,000/year. China alone has 1.2 Billion and is obsessed with surveillance. I think China will mandate identity verification with our system. I'll charge a $1/query. So that'll be another $1.2 billion+.

How will you get users? If your idea is the type that faces a chicken-and-egg problem in the sense that it won't be attractive to users till it has a lot of users (e.g. a marketplace, a dating site, an ad network), how will you overcome that?
Right away we're going to get paying customers who want to add information to their public profiles.
...
Me 80% and 20% for late stage venture capital. I won't have investors and board until as late as possible for maximum control.
